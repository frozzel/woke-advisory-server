...
exports.getNews = async (req, res) => {
    ...
    try{
      const response = await fetch('https://newsapi.org/v2/everything?q=school+transgender&searchIn=title&from=2023-07-20&to=2023-08-12&sortBy=popularity', options);
